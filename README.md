...
> [!NOTE]
> The payload was designed for a Flipper Zero using the classic Rubber Ducky Scripting Language 1.0 to exfiltration data through the use of a Discord webhooks. It can also be used as a regular payload with a webhook.
