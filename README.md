...
> [!NOTE]
> If you would like to provide appropriate attribution, you may simply refer to GitHub [repository](https://github.com/cxdzc/network-payload) or GitHub account [@cxdzc](https://github.com/cxdzc).
